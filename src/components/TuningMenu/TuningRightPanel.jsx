...
const TuningRightPanel = ({ activeSection, gearingData, rpmLimit }) => {
  ...
  return (
    <div className="w-full lg:w-1/4 bg-black/80 backdrop-blur-md border-t lg:border-t-0 lg:border-l border-white/10 p-4 md:p-6 lg:p-8 pt-8 lg:pt-12 flex flex-col">
