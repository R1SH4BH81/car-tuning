export const engine_swap = {
  ...
  v10_performance: {
    name: "8.4L V10 Performance",
    description: "High-torque naturally aspirated V10",
    price: 38000,
    baseStats: { hp: 645, torque: 600 },
    stats: { weight: 90, rpmLimit: 500 },
    specs: {
      displacement: "8.4L",
      cylinders: "V10",
      aspiration: "NA",
  ...
  v8_supercharged: {
    ...
    description: "High-output HEMI Powerplant",
    price: 32000,
    baseStats: { hp: 707, torque: 650 },
    stats: { weight: 100 },
    specs: {
      displacement: "6.2L",
      cylinders: "V8",
  ...
  w16_quad_turbo: {
    ...
    description: "The ultimate hypercar powerplant",
    price: 85000,
    baseStats: { hp: 1500, torque: 1180 },
    stats: { weight: 400, rpmLimit: 500 },
    specs: {
      displacement: "8.0L",
      cylinders: "W16",
  ...
  i6_tt_performance: {
    name: "3.0L I6 Twin-Turbo",
    description: "Modern German precision performance",
    price: 26000,
    baseStats: { hp: 500, torque: 440 },
    stats: { weight: 45, rpmLimit: 1000 },
    specs: {
      displacement: "3.0L",
      cylinders: "I6",
  ...
  v6_dtm_spec: {
    name: "2.5L V6 DTM",
    description: "Ultra-high revving race spec V6",
    price: 42000,
    baseStats: { hp: 490, torque: 350 },
    stats: { weight: -10, rpmLimit: 4000 },
    specs: {
      displacement: "2.5L",
      cylinders: "V6",
      aspiration: "NA",
  ...
  racing_i6_n_a: {
    name: "3.2L Racing I6",
    description: "Classic high-flow straight-six",
    price: 22000,
    baseStats: { hp: 430, torque: 300 },
    stats: { weight: 20, rpmLimit: 1500 },
    specs: {
      displacement: "3.2L",
      cylinders: "I6",
      aspiration: "NA",
...
export const ignition = {
  ...
  sport: { name: "Sport ECU", price: 2500, multiplier: 0.05, grade: "sport" },
  race: { name: "Race ECU", price: 6000, multiplier: 0.08, grade: "race" },
};
